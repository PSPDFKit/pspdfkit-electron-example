...
This repository contains an example integration of [PSPDFKit for Electron](https://pspdfkit.com/electron). The project structure is influenced by the default Electron example app and comes with the following files, among other:
